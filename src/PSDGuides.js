/**
 * psd-guides - Draw photoshop-like guides
 * @version v1.0.1
...
// (function () {
  function PSDGuides(config) {
    this.config = {
      ...
      canvasWidth: 0,
      alignment: "center",
      backColor: "rgba(132, 170, 234, 0)",
      // lineColor: "rgba(73, 141, 255, 0.5)",
      lineColor: "cyan",
      horizontalGuides: [],
      verticalGuides: [],
      zindex: 9999
  ...
  PSDGuides.prototype._init = function _init() {
    ...
    this._setStyles(this._ui.wrapper, {
      ...
      top: 0,
      height: "100%",
      borderLeft: "1px solid " + this.config.lineColor,
      borderRight: "1px solid " + this.config.lineColor
  ...
  PSDGuides.prototype._createVerticalLines = function _createVerticalLines() {
    ...
    this.getVerticalGuides().map(function (guide) {
      this._appendLine(fragment, {
        height: guide + "px",
        borderBottom: "1px solid " + this.config.lineColor
      });
